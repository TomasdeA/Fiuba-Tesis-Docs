...
% graphicx
%
%\input{__Header/graphicx/graphicx} %En teoria esto ya no hace mas falta (MODO BETA)
\usepackage{graphicx}
...
\input{__Header/Listings/mystyle}
...
\input{__Header/mdframed/styles}
%--------------------------------------------------------------------------------------
...
%---------------------------------------------------------------------------------------
% Mejoras tipográficas: protrusión y expansión de fuente (incluye ttfamily).
% Permite que LaTeX quiebre líneas con texto monoespaciado largo.
